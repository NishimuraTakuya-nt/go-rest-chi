...
func Validate(s interface{}) *apperror.ValidationErrors {
	err := GetValidator().Struct(s)
	if err == nil {
		return nil
	}

	errors := apperror.NewValidationErrors()
...
func ValidateVar(field interface{}, tag, namespace string) *apperror.ValidationErrors {
