...
// Source: github.com/NishimuraTakuya-nt/go-rest-chi/internal/domain/service (interfaces: TokenService)
...
func (m *MockTokenService) ValidateToken(arg0 context.Context, arg1 string) (*model.Claims, error) {
	m.ctrl.T.Helper()
