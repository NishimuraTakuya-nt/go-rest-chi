...
// Source: github.com/NishimuraTakuya-nt/go-rest-chi/internal/domain/interface/external/piyographqls (interfaces: SampleClient)
...
func (m *MockSampleClient) CreateSample(arg0 context.Context, arg1 *model.Sample) (*model.Sample, error) {
	m.ctrl.T.Helper()
...
func (m *MockSampleClient) ListSample(arg0 context.Context, arg1, arg2 *int) ([]*model.Sample, error) {
	m.ctrl.T.Helper()
...
func (m *MockSampleClient) Sample(arg0 context.Context, arg1 string) (*model.Sample, error) {
	m.ctrl.T.Helper()
